package net.artemoluwo.modid.item;
...
public class ModItemGroups {
    public static final ItemGroup PINK_GARNET_ITEMS = Registry.register(
    ...
    public static final ItemGroup PINK_GARNET_BLOCKS = Registry.register(
            Registries.ITEM_GROUP,
